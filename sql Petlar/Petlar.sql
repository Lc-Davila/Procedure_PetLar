...
CALL CadastrarPet('Apollo', 'Cachorro', 'Pitbull', '2022-02-15', 'Macho', 'Resgatado', 5);

CALL CadastrarUsuario('Joana Teste', '98765432100', '1999-12-12', 'joana@email.com', 4);
